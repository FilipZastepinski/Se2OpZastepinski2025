...
public class AutovermietungAnwendungssystem {
	...
	// MODEL START -> Objekte von auto immer im Model anlegen (anlegen von Daten)
    ...
    public AutovermietungAnwendungssystem(Stage primaryStage){
    	...
    	primaryStage.show();
    	this.initKomponenten(); //View aufruf -> anwView.initKomponenten();
		this.initListener(); // View aufruf
		*/
		// CONTROL ENDE
    }
   ...
   // VIEW ENDE
    ...
    // CONTROL / MODEL START -> BEACHTEN DB OPERATION IN MODEL, FEHLERERHEBUNG IM CONTROL
